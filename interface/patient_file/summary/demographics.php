    ...
    <div id="container_div" class="<?php echo $oemr_ui->oeContainer(); ?> mb-2">
        ...
        <div class="main mb-1">
            ...
            <div class="row">
                ...
                // 5. MEDICAL PROBLEMS CARD (second row, middle)
                if ($pl === 1) {
                ...
                // 6. MEDICATION CARD (second row, right)
                if ($meds === 1) {
                ...
                // 7. PRESCRIPTIONS CARD (third row, left)
                ...
                // 8. RECALL CARD (third row, middle)
                if ($resNotNull) {
                ...
                // 9. POLAR VASCULAR ACCESS SAFETY CHECKLIST (third row, right)
            ...
            <div class="row">
                ...
                <div class="col-md-8 px-2">
                    ...
                    while ($gfrow = sqlFetchArray($gfres)) :
                        ...
                        $viewArgs = [
                            ...
                            'id' => $vitals_form_id,
                            'initiallyCollapsed' => shouldExpandByDefault($vitals_form_id),
                            'btnLabel' => 'Trend',
                            'btnLink' => "../encounter/trend_form.php?formname=vitals&context=dashboard",
                            'linkMethod' => 'html',
                            'bodyClass' => 'notab collapse show',
                ...
                <div class="col-md-4 px-2">
                    ...
                    // POLAR Healthcare: Function to determine if section should be expanded by default
                    function shouldExpandByDefault($sectionId) {
                        ...
                        $alwaysExpand = [
                            ...
                            'vascular_access_reminders_ps_expand',
                            'patient_reminders_ps_expand'
                        ];
                        
                        return in_array($sectionId, $alwaysExpand) ? false : ((getUserSetting($sectionId) == 0) ? true : false);
                    }
