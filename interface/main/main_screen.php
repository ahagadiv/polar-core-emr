...
///////////////////////////////////////////////////////////////////////
    ...
    // POLAR Healthcare: Use false to preserve session data during regeneration
    ...
    // This is not a new login, so check csrf but don't regenerate session ID
    // POLAR Healthcare: Don't regenerate session on every page load to prevent session loss
    if (!CsrfUtils::verifyCsrfToken($_POST["csrf_token_form"])) {
        CsrfUtils::csrfNotVerified();
    }
    // session_regenerate_id(false); // Removed to prevent session loss on page refresh
}
