...
<head>
    ...
    <script src="<?php echo $GLOBALS['webroot']; ?>/public/js/session_keepalive.js?v=<?php echo $v_js_includes; ?>"></script>
    ...
    <div id="mainBox" <?php echo $disp_mainBox ?>>
        <nav class="navbar navbar-expand-xl navbar-light bg-light py-0">
            <?php if ($GLOBALS['display_main_menu_logo'] === '1') : ?>
                <a class="navbar-brand" href="https://polarhealthcare.net" title="POLAR Healthcare" rel="noopener" target="_blank">
                    <img src="<?php echo $menuLogo; ?>" class="d-inline-block align-middle" height="40" alt="POLAR Healthcare Logo">
                </a>
            <?php endif; ?>
