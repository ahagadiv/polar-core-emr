...
if (
    ...
    // POLAR Healthcare: DISABLED - No session validation for persistent sessions
    // Clinicians need persistent sessions for bedside care without forced logouts
    // if (!AuthUtils::authCheckSession()) {
    //     // Session validation disabled for persistent sessions
    // }
}
...
// POLAR Healthcare: DISABLED - No session timeouts for persistent sessions
// Clinicians need persistent sessions for bedside care without forced logouts
// if (empty($skipSessionExpirationCheck) && empty($_REQUEST['skip_timeout_reset'])) {
//     // Session expiration check disabled for persistent sessions
// }
